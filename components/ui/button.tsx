...
const buttonVariants = cva(
  "group/button inline-flex shrink-0 items-center justify-center rounded-xl border border-transparent text-sm font-medium whitespace-nowrap transition-all duration-150 outline-none select-none focus-visible:ring-2 focus-visible:ring-indigo-600/40 active:scale-[0.98] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        default: "bg-[#4F46E5] text-white hover:bg-[#3730A3] shadow-sm active:scale-[0.98]",
        outline:
          "border-[#CBD5E1] bg-white text-[#334155] hover:bg-slate-50 hover:border-slate-400 hover:text-[#0F172A] shadow-2xs",
        secondary:
          "bg-[#EFF6FF] text-[#4F46E5] border border-indigo-200/60 hover:bg-indigo-100/80 hover:text-[#3730A3]",
        ghost:
          "text-[#475569] hover:bg-[#EFF6FF] hover:text-[#4F46E5]",
        destructive:
