    ...
    return (
      <div className="space-y-6 pb-20">
         ...
         <div className={`p-6 rounded-[2rem] border shadow-xs min-h-[55vh] flex flex-col gap-4 relative overflow-hidden transition-all duration-300 ${
           editColor === "blue" ? "bg-teal-50 border-teal-200/50" :
            ...
            <div className="flex flex-col gap-2 pt-3 border-t border-black/5 relative z-10">
              ...
              <div className="flex gap-2.5">
                {[
                  ...
                  { key: "blue", label: "Blue", class: "bg-teal-50 border-teal-200/60" },
  ...
  return (
    <div className="space-y-6 pb-20">
      <div className="flex items-center justify-between pt-6 md:pt-8 px-1">
        ...
        <div className="flex items-center gap-2 bg-teal-50 text-teal-700 px-3 py-1.5 rounded-full border border-teal-100 shadow-3xs">
      ...
      <div className="flex gap-2 relative px-1">
         ...
         <Input 
           ...
           className="w-full h-14 bg-white pl-12 text-[14px] font-medium rounded-2xl outline-none transition-all border border-slate-100 shadow-sm focus:ring-2 focus:ring-teal-100 focus:border-teal-200" 
         />
      </div>
      ...
      <div className="grid gap-5 px-1 mt-2">
        {filteredNotes.length === 0 ? (
          ...
          const cardBg = 
            n.color === "blue" ? "bg-teal-50 border-teal-200/50 hover:border-teal-300" :
          ...
          return (
            ...
            >
               <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-all transform translate-x-2 group-hover:translate-x-0 bg-white/90 backdrop-blur px-2 py-1 rounded-xl shadow-sm border border-slate-100 z-20">
                  <Button variant="ghost" size="icon" onClick={(e) => { e.stopPropagation(); setActiveNote(n); setEditTitle(n.title); setEditContent(n.content); setEditColor(n.color || "white"); setIsCreating(true); }} className="w-9 h-9 rounded-lg text-slate-400 hover:text-teal-700 hover:bg-teal-50"><Edit2 className="w-4 h-4"/></Button>
               ...
               <div className="flex flex-col gap-3">
                 ...
                 <div className="flex items-center gap-2 mt-2">
                   <div className="flex items-center gap-1.5 text-[10px] font-semibold text-slate-400 uppercase tracking-widest bg-white/60 px-2.5 py-1.5 rounded-lg border border-slate-150 shadow-3xs">
                     <Clock className="w-3.5 h-3.5 text-teal-600"/> {n.time}
                   </div>
                 </div>
               </div>
            </div>
