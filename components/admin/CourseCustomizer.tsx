    ...
    <div className="space-y-6 pb-20 w-full">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-2 text-[11px] font-bold tracking-widest text-slate-400 uppercase">
          ...
          <span className="text-slate-300">/</span>
          <span className="text-blue-600 font-extrabold">Edit</span>
        </div>
      </div>
          ...
          <div className="px-8 py-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                ...
                className="text-blue-600 text-[10px] font-black uppercase tracking-tight flex items-center gap-1.5 px-3 py-1.5 bg-blue-50 rounded-xl active:scale-95 transition-transform"
              >
            ...
            <AnimatePresence>
              {addingModuleMode && (
                <motion.div
                  className="glass-card rounded-[2rem] p-6 border-blue-200 mb-6"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 outline-none focus:bg-white focus:border-blue-400"
                      />
                    </div>
                    <div>
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          newModuleTitle.trim() ? "bg-blue-600 text-white shadow-lg shadow-blue-200" : "bg-slate-100 text-slate-300"
                        )}
                      >
                        Create Module
                      </button>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <button
                          ...
                          className={cn(
                            ...
                            mod.enabled ? "bg-blue-600 text-white shadow-blue-500/20" : "bg-slate-100 text-slate-300 shadow-none"
                          )}
                        >
                          ...
                          {isEditing ? (
                            <div className="space-y-2" onClick={(e) => e.stopPropagation()}>
                              <input
                                ...
                                className="w-full bg-slate-50 border border-slate-100 rounded-lg px-3 py-1.5 text-sm font-bold text-slate-900 outline-none focus:bg-white focus:border-blue-400"
                              />
                              <input
                                value={mod.description}
                                onChange={(e) => updateModule(mod.id, { description: e.target.value })}
                                className="w-full bg-slate-50 border border-slate-100 rounded-lg px-3 py-1.5 text-xs text-slate-500 outline-none focus:bg-white focus:border-blue-400"
                              />
                            </div>
                          ) : (
                        ...
                        <div className="flex items-center gap-1 shrink-0">
                          <button
                            ...
                            className={cn(
                              ...
                              isEditing ? "text-blue-600 bg-blue-50" : "text-slate-300 hover:text-blue-600"
                            )}
                          >
                        ...
                        {isExpanded && (
                          ...
                          >
                                ...
                                >
                                    ...
                                    {isLessonEditing ? (
                                      <div className="flex-1 flex flex-wrap items-center gap-3" onClick={(e) => e.stopPropagation()}>
                                        <input
                                          ...
                                          className="flex-1 min-w-[200px] px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-sm font-bold outline-none focus:border-blue-400 text-slate-900 shadow-sm"
                                        />
                                        <select
                                          value={lesson.type}
                                  ...
                                  <div className="flex items-center gap-1 shrink-0">
                                    <button
                                      ...
                                      className={cn(
                                        "p-2 rounded-xl transition-colors",
                                        isLessonEditing ? "text-blue-600 bg-blue-50" : "text-slate-300 hover:text-blue-600"
                                      )}
                                    >
                                    ...
                                    <button
                                      ...
                                      className={cn("p-2 transition-all", lesson.enabled ? "text-blue-600" : "text-slate-300")}
                                    >
                            ...
                            <button
                              ...
                              className="w-full py-4 rounded-2xl border-2 border-dashed border-slate-100 text-slate-400 text-[11px] font-black uppercase tracking-[0.2em] hover:bg-white hover:text-blue-600 hover:border-blue-200 transition-all flex items-center justify-center gap-2 mt-4"
                            >
            ...
            {addingModule && (
              ...
              >
                <div className="space-y-4">
                  <div>
                    <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1.5 block">Module Title</label>
                    <input autoFocus placeholder="Enter title..." value={newModTitle} onChange={(e) => setNewModTitle(e.target.value)} className="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 text-sm font-medium text-slate-900 outline-none focus:bg-white focus:border-blue-400" />
                  </div>
                  <div className="flex gap-2">
                    ...
                    <button onClick={addNewModule} disabled={!newModTitle.trim()} className={cn("flex-1 py-3 rounded-xl text-xs font-medium transition-all", newModTitle.trim() ? "bg-blue-600 text-white shadow-lg shadow-blue-200" : "bg-slate-100 text-slate-300")}>Create Module</button>
                  </div>
                </div>
              </motion.div>
            )}
