        ...
        <div className="px-5 py-6 bg-white border-b border-slate-100 flex flex-col gap-6 shrink-0">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
               ...
               <span className="px-3 py-1 bg-violet-50 text-violet-600 rounded-full text-[10px] font-bold uppercase tracking-wider border border-violet-100">
                 {(() => {
          ...
          <div className="space-y-4">
             <div>
               <p className="text-[11px] font-bold text-slate-400 uppercase tracking-widest mb-3">Enrolled Student & Mentor Pairings</p>
                       ...
                       <div key={enrollment.id} className="flex flex-col gap-2 p-3.5 bg-slate-50/50 rounded-2xl border border-slate-100 hover:border-blue-200 transition-all">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2.5">
                               ...
                               <div>
                                 <p className="text-[13px] font-bold text-slate-900">{student?.name || "Anonymous Student"}</p>
                          ...
                          <div className="mt-2 pt-2 border-t border-slate-100/50 flex items-center gap-2">
                             ...
                             <p className="text-[11px] font-semibold text-slate-500">
                               Mentor: <span className={cn("ml-1 font-bold", mentor ? "text-violet-600" : "text-amber-500 italic")}>
        ...
        <button
          onClick={() => {
            if (currentLesson && onToggleLesson && !isCurrentLessonCompleted) {
              onToggleLesson(currentLesson.id);
