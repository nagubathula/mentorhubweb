      ...
      <CardContent className="p-4 sm:p-5 flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between gap-3 w-full border-b border-[#E2E8F0] pb-3.5">
          <div className="flex items-center gap-3">
            <div className="bg-[#EFF6FF] p-2.5 rounded-2xl text-[#0F766E] shrink-0 shadow-2xs border border-[#0F766E]/20">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="bg-[#EFF6FF] text-[#0F766E] text-[10px] font-bold px-2 py-0.5 rounded-full border border-[#0F766E]/20 uppercase tracking-wider">
                  24/7 Tutor
                </span>
              </div>
          ...
          <div className="max-h-[350px] overflow-y-auto space-y-3.5 pr-1.5 hidden-scrollbar py-1">
            {messages.map((msg) => (
              ...
              >
                <div className="flex items-end gap-2 max-w-[90%] sm:max-w-[85%]">
                  {msg.sender === "ai" && (
                    <div className="w-7 h-7 rounded-full bg-[#0F766E] text-white flex items-center justify-center shrink-0 mb-1 shadow-xs">
            ...
            {isLoading && (
              <div className="flex items-start gap-2">
                <div className="w-7 h-7 rounded-full bg-[#0F766E] text-white flex items-center justify-center shrink-0 animate-pulse">
                  <Bot className="w-4 h-4" />
                </div>
                <div className="px-4 py-3 rounded-2xl bg-[#EFF6FF] border border-[#0F766E]/20 text-[#0F766E] text-[13px] font-semibold flex items-center gap-2 rounded-tl-none">
                  <div className="w-2 h-2 rounded-full bg-[#0F766E] animate-ping" />
                  <span>Thinking...</span>
                </div>
              </div>
            )}
        ...
        <div className="flex flex-col gap-2.5 pt-1">
          <div className="flex gap-2 items-center">
            <div className="relative flex-1">
              <Input
                ...
                className="w-full border border-[#CBD5E1] rounded-2xl pl-4 pr-10 py-3 bg-[#F8FAFC] text-[14px] text-[#0F172A] placeholder-[#94A3B8] outline-none hover:bg-white hover:border-[#0F766E] focus-visible:border-[#0F766E] focus-visible:ring-2 focus-visible:ring-[#0F766E]/20 transition-all disabled:opacity-50 h-11"
              />
          ...
          <div className="flex flex-wrap items-center gap-1.5 pt-1">
            <span className="text-[11px] font-bold text-[#64748B] mr-1 flex items-center gap-1">
              <HelpCircle className="w-3 h-3 text-[#0F766E]" /> Suggested:
            </span>
            {SUGGESTED_QUESTIONS.map((chipText, cIdx) => (
              <button
                ...
                className="px-3 py-1 rounded-full border border-[#E2E8F0] bg-[#F8FAFC] text-[11.5px] font-semibold text-[#475569] hover:bg-[#EFF6FF] hover:text-[#0F766E] hover:border-[#0F766E]/30 transition-all active:scale-95 disabled:opacity-50 text-left"
              >
                {chipText}
              </button>
            ))}
