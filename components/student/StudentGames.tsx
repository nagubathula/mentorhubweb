          ...
          {(["snakes", "ludo", "kbc", "leaderboard"] as const).filter((tab) => {
            ...
            const icon =
              tab === "snakes" ? (
                ...
                <Dices className={cn("w-3.5 h-3.5 transition-colors", isActive ? "text-indigo-500" : "text-slate-400")} />
              ) : tab === "kbc" ? (
          ...
          <div className="bg-slate-50 border border-slate-100 rounded-2xl p-4 mb-6">
            <div className="flex items-center justify-between">
              <div className="flex flex-col items-center gap-1">
                <div className="w-10 h-10 rounded-full bg-indigo-500 text-white flex items-center justify-center font-medium text-sm shadow-md">
                  {firstLetter}
                </div>
    ...
    <div className="flex flex-col gap-1.5 font-sans pb-2">
      ...
      <div className="flex items-center justify-between px-3 py-1.5 bg-transparent">
        ...
        <div className="flex items-center gap-1.5">
          <div className="w-5 h-5 rounded-full bg-indigo-500 text-white flex items-center justify-center text-[9px] font-bold shrink-0">{firstLetter}</div>
          ...
          {Object.keys(rowCells)
            .map((rKey: any) =>
              rowCells[rKey].map(({ num }) => {
                ...
                else if (isStart) cellBg = "bg-indigo-50 border-indigo-200 text-indigo-500";
                    ...
                    {isBothHere ? (
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="flex -space-x-2 scale-90">
                          <motion.div className="w-5 h-5 rounded-full bg-indigo-500 flex items-center justify-center text-white text-[8px] font-extrabold ring-1 ring-white shadow-sm z-10" layoutId="player-token">
                            {firstLetter}
                          </motion.div>
                      ...
                      <motion.div className="absolute inset-0 flex items-center justify-center z-10" layoutId="player-token">
                        <motion.div className="w-6.5 h-6.5 rounded-full bg-indigo-500 flex items-center justify-center text-white text-[10px] font-extrabold ring-1 ring-white shadow-sm">
                          {firstLetter}
                        </motion.div>
                      </motion.div>
                    ) : isAiHere ? (
  ...
  return (
    <div className="flex flex-col gap-1.5 font-sans pb-2">
      ...
      <div className="bg-white rounded-xl p-1.5 border border-slate-100 shadow-sm relative max-w-md mx-auto w-full">
        <div className="grid grid-cols-15 gap-px" style={{ gridTemplateColumns: "repeat(15, 1fr)" }}>
          {N9.map((row, rIdx) =>
            row.map((cell, cIdx) => {
              ...
              if (cell === "B") cellBg = "bg-indigo-100/70";
                ...
                cellBg = "bg-blue-200";
                cellBorder = "border border-indigo-300";
              } else if (cell === "RS") {
                cellBg = "bg-rose-200";
                ...
                >
                  ...
                  {isBothHere ? (
                    <div className="flex gap-px absolute z-10 scale-90">
                      <div className="w-2 h-2 rounded-full bg-indigo-500 border border-white" />
                      <div className="w-2 h-2 rounded-full bg-rose-500 border border-white" />
                    </div>
                  ) : isPlayerHere ? (
                    <motion.div className="w-3.5 h-3.5 rounded-full bg-indigo-500 flex items-center justify-center text-white text-[5px] font-extrabold ring-1 ring-white shadow-sm z-10" layoutId="ludo-p">
                      {firstLetter}
                    </motion.div>
                  ) : isAiHere ? (
        ...
        {playerPosition === 0 && (
          <div className="flex items-center gap-1 mt-1.5 px-0.5 text-[8px] text-indigo-500 font-semibold leading-none">
            <div className="w-3 h-3 rounded-full bg-indigo-500 flex items-center justify-center text-white text-[5.5px] font-extrabold">{firstLetter}</div>
            ...
            return (
              ...
              >
                ...
                <div className="relative shrink-0">
                  {std.isUser ? (
                    <div className="w-8.5 h-8.5 rounded-full bg-indigo-500 text-white font-extrabold flex items-center justify-center text-xs shadow-md border-2 border-slate-700">
