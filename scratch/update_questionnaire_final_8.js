...
const studentOnboardingQuestions = [
  ...
  },
  {
    ...
    icon: "Code", // Matches the <> icon in screenshot
    color: "#3b82f6", // Blue
    questions: [
  ...
  },
  {
    ...
    icon: "BookOpen", // Matches the book icon in screenshot
    color: "#14b8a6", // Teal
    questions: [
  ...
  },
  {
    step: 8,
    title: "Fun Questions",
    icon: "Zap", // Matches the lightning bolt icon in screenshot
    color: "#f97316", // Orange
    questions: [
...
async function update() {
  ...
  if (error) {
    ...
    console.log('Success updating Student Onboarding Questionnaire with all 8 phases and exact icons/colors');
  }
}
