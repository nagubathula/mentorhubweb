...
export default function GamesQuizzesPage() {
  return (
    <div className="p-10">
      <div className="mb-8">
        <h1 className="text-2xl font-semibold tracking-tight text-slate-900">Games & Quizzes</h1>
        <p className="text-[15px] text-slate-500 mt-1">Manage games & quizzes</p>
      </div>
